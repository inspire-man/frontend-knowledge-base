...
2026 年,Signal 范式也在影响 React 生态——Preact Signals、以及 React 官方讨论中的 signal API 提案。相比 Redux/Zustand 的"Store + 订阅",Signal 提供**更细粒度的自动依赖追踪**(读时订阅、写时通知),有望成为下一代默认。机制见 6.1。
...
📎 参考:Redux Toolkit 文档、[Zustand 文档](https://github.com/pmndrs/zustand)、TanStack Query 文档