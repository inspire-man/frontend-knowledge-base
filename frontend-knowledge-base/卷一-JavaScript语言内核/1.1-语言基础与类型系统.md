...
📎 参考:ECMA-262(类型系统 / ToPrimitive)、[MDN《JavaScript 数据类型和数据结构》](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Data_structures)、V8《Memory management》/《escape analysis》