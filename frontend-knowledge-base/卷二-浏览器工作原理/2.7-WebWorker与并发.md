...
> 同一算法也用于 `structuredClone()`(见 [1.1](/卷一-JavaScript语言内核/1.1-语言基础与类型系统)):支持循环引用、保留 Date/Map/Set/ArrayBuffer 等类型。
...
📎 参考:[MDN《Web Workers API》](https://developer.mozilla.org/zh-CN/docs/Web/API/Web_Workers_API)《结构化克隆算法》《SharedArrayBuffer》

📎 权威延伸阅读:
- 《Web Workers API》(MDN) https://developer.mozilla.org/zh-CN/docs/Web/API/Web_Workers_API
- 《The structured clone algorithm》(MDN) https://developer.mozilla.org/zh-CN/docs/Web/API/Web_Workers_API/Structured_clone_algorithm
- 《Using Transferable objects》(MDN) https://developer.mozilla.org/zh-CN/docs/Web/API/Web_Workers_API/Transferable_objects