...
**SSE 服务器端(关键:Content-Type = text/event-stream):**
...
**WebSocket 的建立:HTTP Upgrade 握手**

WebSocket 不是新协议,而是先发一个 HTTP 请求,**带 Upgrade 头**请求升级:
...
> 握手成功后,这条 HTTP 连接**升级成 WebSocket 双向通道**,不再走请求-响应,而是持久全双工发消息。这就是"ws"能双向的原因。
...
📎 官方:[MDN《AbortController》](https://developer.mozilla.org/zh-CN/docs/Web/API/AbortController) · [AbortSignal](https://developer.mozilla.org/zh-CN/docs/Web/API/AbortSignal)
...
📎 官方:[MDN《AbortSignal.timeout()》](https://developer.mozilla.org/zh-CN/docs/Web/API/AbortSignal/timeout_static)
...
📎 参考:[MDN《Fetch API》](https://developer.mozilla.org/zh-CN/docs/Web/API/Fetch_API)《EventSource》《WebSocket》、axios 官方文档