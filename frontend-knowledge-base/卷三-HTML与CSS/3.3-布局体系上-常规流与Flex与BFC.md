...
📎 参考:[MDN《BFC》](https://developer.mozilla.org/zh-CN/docs/Web/CSS/CSS_flow_layout/Introduction_to_formatting_contexts)《flexbox》、CSS2.1 规范 margin-collapsing、CSS Flexbox 规范(flex-shrink 算法)