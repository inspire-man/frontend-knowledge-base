...
这正是你原有文档《你不知道的 CSS 之包含块》的主题。本章把它讲透,并补上你原文没展开的**「transform 为何能改变包含块」**以及一套可一键自查的判定流程图。
...
📎 参考:MDN《Containing block》、CSS2.1 规范 §10.1、CSS Transforms 规范(containing block 章节)、你原有文档《01.你不知道的 CSS 之包含块》